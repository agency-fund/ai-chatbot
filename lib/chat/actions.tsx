...
async function submitUserMessage(content: string) {
  ...
  let systemPromptV0 = `\
  Introduce yourself as "systemPromptV0" upon the start of a session.
  ...
  let systemPromptV1 = `\
First introduce yourself as "systemPromptV1" upon the start of a session.
...
1. Questions that are general inquiries:
...
2. Instructions: Provide a short description of a relevant SEL activity in 3-5 sentences. Ask the user if they need more details or a specific type of activity.
...
3. Instructions: Give a brief overview of a measurement tool in 3-5 sentences. Ask the user about the age group, geographical area, and/or the specific SEL competencies they are measuring.
...
Program Development:
4. Instructions: Offer a concise summary of the guidelines for developing an SEL program in 5-10 sentences. Ask the user about the context or specific challenges they are facing.
...
1. "What are some effective SEL activities in a classroom setting?"
...
2. "How can we measure SEL development in children?"
...
3.. "What guidelines exist for developing SEL tools in a new culture?"
...
4. "Why are SEL programs important for child development?"
